...
public class PickWidgetDialog {
    ...
    AlertDialog fDialog;
    private final WidgetPickerActivity fOwner;
    ...
    private class CancelListener implements OnCancelListener {
        ...
        public void onCancel(DialogInterface dialog) {
            if (fCancelOwner) {
                PickWidgetDialog.this.fOwner.setResult(WidgetPickerActivity.RESULT_CANCELED);
    ...
    public PickWidgetDialog(WidgetPickerActivity owner) {
        fOwner = owner;
    }
